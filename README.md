...
<!-- При выполнении команды "npm start" запустятся 2 сервера: сервер приложения на http://localhost:3000 и JSON сервер с данными из seminars.json на http://localhost:5000 -->
